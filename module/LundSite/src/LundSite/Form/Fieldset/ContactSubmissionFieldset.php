 ...
 * @version    GIT: $Id$
 */
class ContactSubmissionFieldset extends Fieldset
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('contact-submission-fieldset');

        $this->setHydrator(new DoctrineHydrator($objectManager, 'LundSite\Entity\ContactSubmission'));
