...
/**
 * Service factory that instantiates {@see TestimonialService}.
 */
class TestimonialServiceFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        $testimonialService = new TestimonialService(
            ...
            $serviceLocator->get('LundSite\Repository\TestimonialRepository'),
            $serviceLocator->get('FormElementManager')->get('LundSite\Form\TestimonialForm')
        );

        $testimonialService->setTestimonialPrototype($serviceLocator->get('LundSite\Entity\TestimonialPrototype'));
