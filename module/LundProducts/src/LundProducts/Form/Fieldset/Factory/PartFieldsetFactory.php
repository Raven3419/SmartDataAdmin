...
use LundProducts\Form\Fieldset\PartFieldset;
use Zend\ServiceManager\FactoryInterface;
use Zend\ServiceManager\ServiceLocatorInterface;

/**
 * Service factory that instantiates {@see PartFieldset}.
 */
class PartFieldsetFactory implements FactoryInterface
{
    /**
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $fieldset = new PartFieldset($objectManager);
