...
class ParseMasterServiceFactory implements FactoryInterface
{
    /**
     * Create ParseMasterService from factory
     *
     * @param ServiceLocatorInterface $serviceLocator
     *
     * @return ParseMasterService
     */
