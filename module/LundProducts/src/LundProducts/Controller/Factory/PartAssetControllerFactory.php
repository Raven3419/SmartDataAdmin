 ...
 * @version    GIT: $Id$
 */
class PartAssetControllerFactory implements FactoryInterface
{
    /**
     * @param \Zend\ServiceManager\ServiceLocatorInterface $sl
     *
     * @return \LundProducts\Controller\PartAssetController
     */
    public function createService(ServiceLocatorInterface $sl)
    {
        ...
        $cn = new \LundProducts\Controller\PartAssetController(
