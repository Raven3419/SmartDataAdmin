 ...
 * @link       https://github.com/rocketred/www-lunddigitalplatform for the canonical source repository
 */
class ProductLineFeatureControllerFactory implements FactoryInterface
{
    /**
     * @param \Zend\ServiceManager\ServiceLocatorInterface $sl
     *
     * @return \LundProducts\Controller\ProductLineFeatureController
     */
    public function createService(ServiceLocatorInterface $sl)
    {
        ...
        $cn = new \LundProducts\Controller\ProductLineFeatureController(
            $sm->get('LundProducts\Service\ProductLineService'),
            $sm->get('LundProducts\Service\ProductLineFeatureService'),
