 ...
 */
class OrderItem extends \RocketEcom\Entity\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'productId', 'quantity', 'description', 'price', 'weight', 'length', 'height', 'width', 'upcCode', 'orderItemId', 'order');
        }
    ...
    public function getOrderItemId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderItemId', array());
     ...
     * {@inheritDoc}
     */
    public function setOrder(\RocketEcom\Entity\Orders $order = NULL)
    {
