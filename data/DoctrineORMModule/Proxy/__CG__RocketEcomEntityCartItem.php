...
class CartItem extends \RocketEcom\Entity\CartItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'productId', 'quantity', 'description', 'price', 'weight', 'length', 'height', 'width', 'upcCode', 'cartItemId', 'cart');
        }
