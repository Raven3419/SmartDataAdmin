...
class Page extends \RocketCms\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'title', 'slug', 'content', 'loadInclude', 'position', 'sitemap', 'public', 'metaTitle', 'metaKeywords', 'metaDescription', 'pageId', 'template', 'site', 'parentPage');
        }
