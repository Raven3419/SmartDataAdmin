...
class ProductCategories extends \LundProducts\Entity\ProductCategories implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'name', 'bpcsCode', 'shortCode', 'displayName', 'productCategoryId', 'brandProductCategory', 'asset');
        }
